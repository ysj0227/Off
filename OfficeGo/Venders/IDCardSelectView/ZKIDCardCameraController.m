...
- (void)viewDidLoad {
    ...
    if ([self isCanUseCamera]) {
        ...
        CGFloat buttonWH = 64;
        CGFloat buttonX = (kScreenW-64)/2;
        CGFloat buttonY = kScreenH - 60 - 80;
        self.photoButton.frame = CGRectMake(buttonX, buttonY, buttonWH, buttonWH);
        
        CGFloat cancleButtonWH = 64;
        CGFloat cancleButtonX = 12;
        CGFloat cancleButtonY = kScreenH - 64 - 80;
        self.cancleButton.frame = CGRectMake(cancleButtonX, cancleButtonY, cancleButtonWH, cancleButtonWH);
        
        CGFloat bottomY = (kScreenH-64-80);
        ...
        CGFloat flashWH = 64;
        CGFloat flashX = kScreenW-64;
        CGFloat flashY = kScreenH - 64 - 80;
