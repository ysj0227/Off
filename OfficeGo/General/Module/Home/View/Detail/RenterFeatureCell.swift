...
class RenterFeatureCell: BaseTableViewCell {
    ...
    lazy var titleLabel: UILabel = {
        let view = UILabel(frame: CGRect(x: left_pending_space_17, y: 17, width: 22, height: 24))
    ...
    lazy var featureView: FeatureView = {
        let view = FeatureView(frame: CGRect(x: 50, y: 19, width: self.width - 50, height: 20))
